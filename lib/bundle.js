...
/***/ function(module, exports, __webpack_require__) {
	...
	var menu = new Menu(context, [song1,song2, song3, song4, song5, song6]);
...
/***/ function(module, exports, __webpack_require__) {
	...
	function Song(notes, video, title, band, thumbnail, level) {
	  this.notes = notes;
	...
	Song.prototype.easify = function () {
	  ...
	  this.easy = new Song(easyNotes, this.songPath, this.title);
	...
	Song.prototype.playSong = function (ctx, callback) {
	  ...
	  this.video.oncanplay = function(){
	    ...
	    this.songLoop = setInterval(function(){
	      ...
	      ctx.fillStyle = "white";
	      ctx.fillText("SCORE: " + this.score, 510, 50);
	
	      if(this.score >= this.highScore){
	        ctx.fillStyle = "green";
	        ctx.fillText("HIGHSCORE: "+ this.score, 510, 400);
	      }
	      else
	        ctx.fillText("HIGHSCORE: "+ this.highScore, 510, 400);
	      ...
	      ctx.fillText("COMBO: " + this.combo, 510, 100);
...
/***/ function(module, exports, __webpack_require__) {
	...
	Menu.prototype.display = function(){
	  ...
	  this.menuLoop = setInterval(function(){
	    ...
	    this.context.drawImage(this.img,575,75,200,200);
